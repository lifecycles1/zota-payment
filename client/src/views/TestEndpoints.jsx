...
const TestEndpoints = () => {
  ...
  const [depositReqResp, setDepositReqResp] = useState({ depositUrl: "", merchantOrderID: "", orderID: "" });
  // state for order status request
  const [orderStatusReq, setOrderStatusReq] = useState({ merchantID: "", merchantOrderID: "", orderID: "", timestamp: "", signature: "" });
  ...
  const [messages, setMessages] = useState({ depositMessage: "", orderStatusMessage: "", timestampAndSignatureMessage: "" });

  // test a single deposit request
  const handleDepositRequest = async () => {
    try {
      console.log("Running deposit request...");
          ...
          <div className="flex flex-col gap-2 mb-4">
            {Object.keys(depositReqPayload).map((key) => (
              <div key={key} className="flex flex-col">
                ...
                <input type="text" name={key} value={depositReqPayload[key]} onChange={handleInputChange} className="p-2 border rounded-md" placeholder={key} />
              </div>
            ))}
          </div>
        ...
        <div className="p-4 border rounded-md shadow-md">
          ...
          <div className="flex flex-col gap-2 mb-4">
            ...
            <div className="flex flex-col">
              ...
              <input type="text" name="timestamp" value={orderStatusReq.timestamp} readOnly className="p-2 border rounded-md" placeholder="timestamp" />
            </div>
            <div className="flex flex-col overflow-x-auto">
              <label className="font-medium">Signature</label>
              <input type="text" value={orderStatusReq.signature} readOnly className="p-2 border rounded-md" placeholder="signature" />
            </div>
          </div>
          <div className="flex flex-col">
